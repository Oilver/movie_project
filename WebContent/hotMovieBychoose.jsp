    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="classicMovie.jsp">电影</a></li>
            </ul>
...
<nav class="subnav navbar-default">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <ul class="navbar">
                <li>
                    <a class="active" data-act="subnav-click" data-val="{subnavClick:1}">正在热映</a>
                </li>
                <li>
                    ...
                    <ul class="tags">
                        <li class="active" data-state-val="{ catTagName:'全部'}">
                            <a data-act="tag-click" data-val="{TagName:'全部'}"
                               href="hotMovie.jsp" style="cursor: default"
                            >全部</a>
                        </li>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'爱情'}"
                               href="movie/seleteMovieBytype1.action?type=0"
                            >爱情</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'喜剧'}"
                               href="movie/seleteMovieBytype1.action?type=1"
                            >喜剧</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'动画'}"
                               href="movie/seleteMovieBytype1.action?type=2"
                            >动画</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'剧情'}"
                              href="movie/seleteMovieBytype1.action?type=3"
                            >剧情</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'恐怖'}"
                               href="movie/seleteMovieBytype1.action?type=4"
                            >恐怖</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'惊悚'}"
                               href="movie/seleteMovieBytype1.action?type=5"
                            >惊悚</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'科幻'}"
                               href="movie/seleteMovieBytype1.action?type=6"
                            >科幻</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'动作'}"
                               href="movie/seleteMovieBytype1.action?type=7"
                            >动作</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'悬疑'}"
                               href="movie/seleteMovieBytype1.action?type=8"
                            >悬疑</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'犯罪'}"
                               href="movie/seleteMovieBytype1.action?type=9"
                            >犯罪</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'冒险'}"
                               href="movie/seleteMovieBytype1.action?type=10"
                            >冒险</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'战争'}"
                               href="movie/seleteMovieBytype1.action?type=11"
                            >战争</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'奇幻'}"
                               href="movie/seleteMovieBytype1.action?type=12"
                            >奇幻</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'运动'}"
                               href="movie/seleteMovieBytype1.action?type=13"
                            >运动</a>
                        <li>
                        ...
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'古装'}"
                               href="movie/seleteMovieBytype1.action?type=15"
                            >古装</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'武侠'}"
                               href="movie/seleteMovieBytype1.action?type=16"
                            >武侠</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'西部'}"
                               href="movie/seleteMovieBytype1.action?type=17"
                            >西部</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'历史'}"
                               href="movie/seleteMovieBytype1.action?type=18"
                            >历史</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'传记'}"
                               href="movie/seleteMovieBytype1.action?type=19"
                            >传记</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'情色'}"
                               href="movie/seleteMovieBytype1.action?type=20"
                            >情色</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'歌舞'}"
                              href="movie/seleteMovieBytype1.action?type=21"
                            >歌舞</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'黑色电影'}"
                               href="movie/seleteMovieBytype1.action?type=22"
                            >黑色电影</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'短片'}"
                               href="movie/seleteMovieBytype1.action?type=23"
                            >短片</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'纪录片'}"
                               href="movie/seleteMovieBytype1.action?type=24"
                            >纪录片</a>
                        <li>
                            <a data-act="tag-click" data-val="{TagName:'其他'}"
                               href="movie/seleteMovieBytype1.action?type=25"
                            >其他</a>
                        </li>
                    </ul>
                </li>
