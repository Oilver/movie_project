 ...
 * 分页工具类
 */
public final class PaginationUtil implements Serializable {
	 ...
	 * @param length
	 */
	public PaginationUtil(int begin, int length) {
		this.begin = begin;
		this.length = length;
	 ...
	 * @param count
	 */
	public PaginationUtil(int begin, int length, int totalRecords) {
		this(begin, length);
	 ...
	 * @param pageNo
	 */
	public PaginationUtil(int pageNo) {
		this.pageNo = pageNo;
